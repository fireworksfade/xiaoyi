...
def upgrade() -> None:
    ...
    sa.Column('purpose', sa.Enum('KNOWLEDGE', 'IOT', 'GENERIC', name='mcppurpose'), nullable=False),
    ...
    sa.Column('enabled', sa.Boolean(), nullable=False),
    sa.Column('risk_policy', sa.Enum('READ_ONLY', 'PROPOSAL_ONLY', 'APPROVAL_REQUIRED', 'DISABLED', name='toolriskpolicy'), nullable=False),
    ...
    with op.batch_alter_table('model_configurations', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_model_configurations_user_id'), ['user_id'], unique=True)
